...
int MC_Ratio(TString _filetag, int leptonId, double par_low, double par_upp, int npar1bins, double par2_low, double par2_upp, int npar2bins, TString sel_den , TString sel_num, double cut_num = 0., TString par_x = "Pt", TString par_y = "eta", TString option = ""){
