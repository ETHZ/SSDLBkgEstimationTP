...
int Ploteff(){
	...
	TFile *f2 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_reliso3_0.100_Pt.root","read");
	TFile *f3 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_reliso3_0.070_Pt.root","read");
	...
	TFile *g2 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_reliso3_0.100_Pt.root","read");
	TFile *g3 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_reliso3_0.070_Pt.root","read");
	...
	he1->SetLineColor(1);
	he1->SetLineWidth(3);
	he1->SetMarkerColor(1);
	he1->SetMarkerStyle(1);
	he1->GetYaxis()->SetRangeUser(0,1.1);
	he2->Draw("same");
	he2->SetLineColor(2);
	he2->SetLineWidth(3);
	...
	leg->AddEntry(he1, "reliso #leq 20%");
	leg->AddEntry(he2, "reliso #leq 10%");
	leg->AddEntry(he3, "reliso #leq 7%");
	leg->SetBorderSize(0.);
	leg->SetTextFont(43);
	leg->SetTextSize(25);
	leg->Draw();
	...
	hmu1->SetLineColor(1);
	hmu1->SetLineWidth(3);
	hmu1->SetMarkerColor(1);
	hmu1->SetMarkerStyle(1);
	hmu1->GetYaxis()->SetRangeUser(0,1.1);
	hmu2->Draw("same");
	hmu2->SetLineColor(2);
	hmu2->SetLineWidth(3);
