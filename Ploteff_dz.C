...
int Ploteff_dz(){
	...
	TFile* file_out = new TFile(location+"eff_dz.root","recreate");

	setTDRStyle();

	TFile *e1pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.030_Pt.root","read");
	TFile *e2pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.020_Pt.root","read");
	TFile *e3pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.010_Pt.root","read");

	TFile *mu1pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.030_Pt.root","read");
	TFile *mu2pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.020_Pt.root","read");
	TFile *mu3pt = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.010_Pt.root","read");

	TFile *e1eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.030_eta.root","read");
	TFile *e2eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.020_eta.root","read");
	TFile *e3eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_e__den_tight_num_dz_0.010_eta.root","read");

	TFile *mu1eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.030_eta.root","read");
	TFile *mu2eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.020_eta.root","read");
	TFile *mu3eta = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/plots_root/efficiencys/eff3ll_alleta_v3_mu__den_tight_num_dz_0.010_eta.root","read");
	...
	leg->AddEntry(he1pt, "dxy #leq 0.3 mm");
	leg->AddEntry(he2pt, "dxy #leq 0.2 mm");
	leg->AddEntry(he3pt, "dxy #leq 0.1 mm");
	leg->SetBorderSize(0.);
	leg->SetTextFont(43);
	leg->SetTextSize(25);
	leg->Draw();
	...
	leg2->AddEntry(hmu1pt, "dxy #leq 0.3 mm");
	leg2->AddEntry(hmu2pt, "dxy #leq 0.2 mm");
	leg2->AddEntry(hmu3pt, "dxy #leq 0.1 mm");
	...
	leg3->AddEntry(he1eta, "dxy #leq 0.3 mm");
	leg3->AddEntry(he2eta, "dxy #leq 0.2 mm");
	leg3->AddEntry(he3eta, "dxy #leq 0.1 mm");
	...
	leg4->AddEntry(hmu1eta, "dxy #leq 0.3 mm");
	leg4->AddEntry(hmu2eta, "dxy #leq 0.2 mm");
	leg4->AddEntry(hmu3eta, "dxy #leq 0.1 mm");
