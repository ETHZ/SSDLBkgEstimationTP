...
int PlotMCTandP_nbins_tight(){

	gStyle->SetOptStat(0);

//Files from TandP
TFile *f1 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIde_isocut04=0.20.root","read");
TFile *f2 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIde_isocut04=0.10.root","read");
TFile *f3= new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIde_isocut04=0.05.root","read");
TFile *f4 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIdmu_isocut04=0.20.root","read");
TFile *f5 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIdmu_isocut04=0.10.root","read");
TFile *f6 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/TandP2_v2_Zeff_beta_use_nbins_debugtightIdmu_isocut04=0.05.root","read");
//Files from MC
TFile *f7 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots/Figure_84.root");
TFile *f8 = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots/Figure_85.root");
...
leg2->Draw();
	...
	TFile* file_out = new TFile("/Users/GLP/Dropbox/Physique/Master_Thesis/analysis/plots_root/PlotMCTandP_nbins_tight.root","recreate");
	c1->Write();
	c2->Write();
	c3->Write();
	c4->Write();
